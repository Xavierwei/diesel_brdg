...
var xhr;
var STR_CITYLABEL = new Array('shanghai','paris','new york','paris - shanghai - new york');
var citylabel = 3;
var fireOnce = true;
var autoSlide;
...
//            }
            ...
            var v_item = $('<div id="media_' + nid + '" class="v_item ' + media_source + '"><img  src="' + media_image + '"/><div class="item_info"><div class="source"><div class="' + media_source + '"></div></div><div class="full_time">' + $_utility.formateNumber(media_date_day) + '/' + $_utility.formateNumber(media_date_month) + '/' + media_date_year + '</div></div><div class="item_icon"><div class="' + media_source + '"></div></div></div>');
            v_item.data('imgdata', {
                'nid': nid
            });
...
//               }
//            } else {
//                var daySpan = $('<div class="date_span"><div class="full_time">' + $_utility.formateNumber(media_date_day) + '/' + $_utility.formateNumber(media_date_month) + '/' + $_utility.formateNumber(media_date_year) + '</div><div class="day">' + $_utility.formateNumber(media_date_day) + '</div></div>')
...
function renderMediaContent(media_data, face, noimg) {
	...
	if(media_data.field_user_city === '2'){
		var nykTimeZone = -13;
		date_media_date = new Date(date_media_date.getTime() - nykTimeZone * 60 * 60 * 1000);
	}
    // Covert Timezone
    ...
    else if(media_data.field_user_city == '2')
    {
        city = 'New York';
    }
	else {
