...
var STR_CITYLABEL = new Array('china','italy','china - italy');
var citylabel = 2;
...
function brdgInit() {
    ...
    $('.popup_content .popup_close').on('click', function(){
    ...
    $('.home_header .login').on('click', function(){
        window.location.href="/data/user/register";
    });
}
...
function renderMediaContent(media_data, face) {
    ...
    $('.cube1_face' + face + ' .date').html(formateNumber(media_date_month) + '/' + media_date_year);
    $('.cube1_face' + face + ' .city').html(STR_CITYLABEL[media_data.field_content_user_city]);
    console.log(STR_CITYLABEL[media_data.field_content_user_city]);
    $('.cube2_face' + face + ' .time_clock').attr('data-hrs', media_date_hrs);
    $('.cube2_face' + face + ' .time_clock').attr('data-min', media_date_min);
    $('.cube2_face' + face + ' .time_text').html(formateNumber(media_date_hrs) + ' : ' + formateNumber(media_date_min));
    $('.cube2_face' + face + ' .time_clock').brdgClock();
    $('.cube3_face' + face).html('').append('<div>#worldofdiesel</div>');
...
function bindvgridEvent() {
    ...
    $('.category li').eq(1).click(function () {
        ...
        citylabel = 2;
        perpage= 0;
        loadData(siteurl + 'data/third_content/img_api?perpage=' + perpage + '&page=0');
    ...
    $('.category li').eq(2).click(function () {
        ...
        citylabel = 3;
        perpage = 0;
        loadData(siteurl + 'data/third_content/video_api?perpage=' + perpage + '&page=0');
